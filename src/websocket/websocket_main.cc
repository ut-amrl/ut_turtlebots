...
void *RosThread(void *arg) {
  ...
  init_loc_pub_ =
      n.advertise<geometry_msgs::msg::PoseWithCovarianceStamped>("/initialpose", 10);
  nav_goal_pub_ =
      n.advertise<geometry_msgs::msg::PoseStamped>("/move_base_simple/goal", 10);
  amrl_init_loc_pub_ =
      n.advertise<amrl_msgs::msg::Localization2DMsg>("/set_pose", 10);
  amrl_nav_goal_pub_ =
      n.advertise<amrl_msgs::msg::Localization2DMsg>("/set_nav_target", 10);
